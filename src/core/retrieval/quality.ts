 ...
 */
import { RRF_K, type HybridHit } from './engine.js'
...
export function diagnoseRetrieval(
  ...
  const verdict: RetrievalVerdict =
    strength >= STRONG_RATIO ? 'strong' : strength >= FAIR_RATIO ? 'fair' : 'weak'
...
export const VERDICT_LABELS: Readonly<Record<RetrievalVerdict, string>> = {
  strong: '强',
  fair: '中',
  weak: '弱',
  empty: '空',
