...
export function generateHandoff(
  request: { sessionId: string; focus?: string; template?: string },
  options?: RequestOptions,
...
export function fetchHandoffLineage(sessionId: string, options?: RequestOptions): Promise<HandoffLineageResponse> {
  return companionGet<HandoffLineageResponse>('/handoff/lineage', { sessionId }, options)
}
...
export function searchRetrieval(
  request: { query: string; from?: string; to?: string; limit?: number },
  options?: RequestOptions,
): Promise<RetrievalSearchResponse> {
  return companionGet<RetrievalSearchResponse>('/retrieval/search', {
    query: request.query,
    from: request.from,
    to: request.to,
    limit: request.limit,
...
export function fetchRetrievalSuggestions(
  request: { q: string },
  options?: RequestOptions,
): Promise<RetrievalSuggestResponse> {
  return companionGet<RetrievalSuggestResponse>('/retrieval/suggest', { q: request.q }, options)
}

/** 读取语义索引状态（已索引会话数与最近对账时间）。 */
export function fetchRetrievalStatus(options?: RequestOptions): Promise<RetrievalStatusResponse> {
  return companionGet<RetrievalStatusResponse>('/retrieval/status', undefined, options)
}
...
export function recordRetrievalFeedback(
  ...
  options?: RequestOptions,
): Promise<RetrievalFeedbackResponse> {
  return companionPost<RetrievalFeedbackResponse>('/retrieval/feedback', request, options)
}

/** 读取知识地图（轴线 13）：全部会话的主题聚类。minSize 过滤簇规模。 */
export function fetchRetrievalClusters(
  request?: { minSize?: number },
  options?: RequestOptions,
): Promise<RetrievalClustersResponse> {
  return companionGet<RetrievalClustersResponse>(
    '/retrieval/clusters',
...
export function fetchRetrievalBlindSpots(options?: RequestOptions): Promise<RetrievalBlindSpotsResponse> {
  return companionGet<RetrievalBlindSpotsResponse>('/retrieval/blindspots', undefined, options)
}
...
export function fetchRetrievalInsights(options?: RequestOptions): Promise<RetrievalInsightsResponse> {
  return companionGet<RetrievalInsightsResponse>('/retrieval/insights', undefined, options)
}

// ---------------------------------------------------------------------------
// 模块 F：对话知识资产（/knowledge/*，轴线 4）
// ---------------------------------------------------------------------------
...
export function fetchKnowledgeStatus(options?: RequestOptions): Promise<KnowledgeStatusResponse> {
  return companionGet<KnowledgeStatusResponse>('/knowledge/status', undefined, options)
}
...
export function fetchKnowledgeEntities(
  ...
  return companionGet<KnowledgeEntitiesResponse>('/knowledge/entities', {
    type: request.type,
    limit: request.limit,
  }, options)
}
...
/** 分析单个会话：实体列表 + 建议标签。 */
export function analyzeSessionKnowledge(
  sessionId: string,
  options?: RequestOptions,
): Promise<KnowledgeAnalyzeResponse> {
  return companionGet<KnowledgeAnalyzeResponse>('/knowledge/analyze', { sessionId }, options)
}

/** 查询与目标会话实体重叠度最高的关联会话。 */
export function fetchRelatedSessions(
  sessionId: string,
  limit?: number,
  options?: RequestOptions,
): Promise<KnowledgeRelatedResponse> {
  return companionGet<KnowledgeRelatedResponse>('/knowledge/related', {
    sessionId,
    limit,
  }, options)
}
...
/** 全量重建知识索引（清空后重分析全部会话）。 */
export function reanalyzeKnowledge(options?: RequestOptions): Promise<KnowledgeReanalyzeResponse> {
  return companionPost<KnowledgeReanalyzeResponse>('/knowledge/reanalyze', undefined, options)
}

// ---------------------------------------------------------------------------
// 认知三轴（轴线 20/21/22：/knowledge/cognition 等认知端点）
// ---------------------------------------------------------------------------
...
export function fetchKnowledgeCognition(options?: RequestOptions): Promise<KnowledgeCognitionResponse> {
  return companionGet<KnowledgeCognitionResponse>('/knowledge/cognition', undefined, options)
}

/** 拉取完整意图清单（到期 30 条 + 即将到来 15 条）。 */
export function fetchKnowledgeIntentions(options?: RequestOptions): Promise<KnowledgeIntentionsResponse> {
  return companionGet<KnowledgeIntentionsResponse>('/knowledge/intentions', undefined, options)
}

/** 复习评分（轴线 21）：记得升档、忘了归零，返回下次复习间隔。 */
export function gradeKnowledgeReview(
  request: { episodeId: string; remembered: boolean },
  options?: RequestOptions,
): Promise<KnowledgeReviewGradeResponse> {
  return companionPost<KnowledgeReviewGradeResponse>('/knowledge/review/grade', request, options)
}

/** 类比检索（轴线 22）：以当前问题描述找结构同构的历史经验。 */
export function searchKnowledgeAnalogy(
  q: string,
  options?: RequestOptions,
): Promise<KnowledgeAnalogyResponse> {
  return companionGet<KnowledgeAnalogyResponse>('/knowledge/analogy', { q }, options)
}

/** 拉取认知脉搏（轴线 18：意图 + 复习 + 片段 + 元认知三类信号）。 */
export function fetchKnowledgePulse(options?: RequestOptions): Promise<KnowledgePulseResponse> {
  return companionGet<KnowledgePulseResponse>('/knowledge/pulse', undefined, options)
}

/** 拉取遗忘预测报告（轴线 23：全库记忆保持率体检）。 */
export function fetchKnowledgeForecast(options?: RequestOptions): Promise<KnowledgeForecastResponse> {
  return companionGet<KnowledgeForecastResponse>('/knowledge/forecast', undefined, options)
}

/** 拉取记忆节律画像（轴线 24：间隔如何随你的表现自适应）。 */
export function fetchKnowledgeRhythm(options?: RequestOptions): Promise<KnowledgeRhythmResponse> {
  return companionGet<KnowledgeRhythmResponse>('/knowledge/rhythm', undefined, options)
}

/** 手动触发全量重建语义索引。 */
export function reindexRetrieval(options?: RequestOptions): Promise<RetrievalReindexResponse> {
  return companionPost<RetrievalReindexResponse>('/retrieval/reindex', undefined, options)
}

// ---------------------------------------------------------------------------
// 轴线 6：上下文压力监测（/handoff/context-health）
// ---------------------------------------------------------------------------
...
export function fetchContextHealth(
  sessionId: string,
  options?: RequestOptions,
): Promise<ContextHealthResponse> {
  return companionGet<ContextHealthResponse>('/handoff/context-health', { sessionId }, options)
}

// ---------------------------------------------------------------------------
// 轴线 7：主题趋势演化（/knowledge/trends）
// ---------------------------------------------------------------------------
...
export function fetchKnowledgeTrends(
  request: { days?: number; limit?: number } = {},
  options?: RequestOptions,
): Promise<KnowledgeTrendsResponse> {
  return companionGet<KnowledgeTrendsResponse>('/knowledge/trends', {
    days: request.days,
    limit: request.limit,
  }, options)
}
...
export function askSynthesis(
  question: string,
  options?: RequestOptions,
): Promise<SynthesisAnswerResponse> {
  return companionPost<SynthesisAnswerResponse>('/synthesis/answer', { question }, options)
}
